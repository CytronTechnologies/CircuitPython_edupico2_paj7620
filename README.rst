...
PyPI <https://pypi.org/project/circuitpython-edupico2-paj7620/>`_.
To install for current user:

.. code-block:: shell

    pip3 install circuitpython-edupico2-paj7620

To install system-wide (this may be required in some cases):

.. code-block:: shell

    sudo pip3 install circuitpython-edupico2-paj7620
...
.. code-block:: shell
    ...
    circup install edupico2_paj7620
...
<https://github.com/CytronTechnologies/CircuitPython_edupico2_paj7620/blob/HEAD/CODE_OF_CONDUCT.md>`_
